...
export default function CartDetails () {
            ...
            <div key={item.id} className=" flex flex-col p-3 border rounded-2xl gap-3">
                <div className="flex flex-row gap-5 flex-1">
                    ...
                    <div className="flex flex-col md:gap-3">
                        ...
                        <p className="line-clamp-3 text-xs sm:text-sm md:text-md md:line-clamp-none lg:text-lg">
                            {item.desc.brief}
                        </p>
                    </div>
                </div>
    ...
    return(
        <section className="py-5 px-4 flex flex-col gap-2">
            ...
            <div className=" h-auto w-full flex flex-col justify-center p-5 gap-5 md:grid md:grid-cols-2 ">
                {itemsList}
            </div>
            { cartItems.length > 0 &&
