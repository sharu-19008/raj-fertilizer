...
export default function Header() {
    ...
    return (
        <header className="relative">
            <nav className="navbar fixed top-0 left-0 px-2 w-full flex flex-row justify-between items-center bg-lime-950  py-2 z-50 shadow-md">
                <Link to="/">
                    <img src={logo} alt="logo" width="177px" loading="eager" fetchPriority="high" />
                </Link>
                ...
                {toggle && (
                    <div className="absolute top-full left-0 min-w-1/2 h-screen bg-green-950 border-gray-700 flex flex-row md:hidden z-10">
                        <ul 
                            className="nav-links text-white text-lg flex flex-col justify-start w-full p-4 font-semibold gap-6 " 
