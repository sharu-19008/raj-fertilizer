...
export default function ProductDetails() {
    ...
    // const product_type = location.pathname;
    // const product_found = products.find((product) => product.id === Number(id) && location.pathname.includes(product.type.toLowerCase()))
    // console.log(product_found)

    const product = products.find((product) => product.id === Number(id) && location.pathname.includes(product.type.toLowerCase()))
    ...
    return (
        <section id="product-details">
            ...
            <div className="flex flex-col gap-3 text-base sm:text-xl">
                    <p>Please contact <strong>Raj Fertilizers</strong> to buy this product.</p>
                    <div>
                ...
                <div className=" flex flex-col items-center gap-5 ">
                    <div className="w-full sm:w-full md:w-90 md:h-90 lg:w-120 lg:h-120">
                        <img 
                            ...
                            loading="lazy"
                            className="w-auto h-auto bg-white md:h-90 md:w-90 lg:w-120 lg:h-120 md:border-b-0" 
                        />
                    </div>
                    <motion.button 
                        whileHover={{
                        ...
                        className="bg-yellow-300 w-full h-10 font-bold cursor-pointer hover:bg-yellow-400 hover:shadow-xl/20 overflow-hidden transition-all duration-200 hover:ring-offset-2 active:ring-2 active:ring-red-800 active:rounded"
                    ...
                    <div className="w-full flex flex-row justify-around gap-5 ">
                        {!location.pathname.includes('fertilizers') && 
                            ...
                            <motion.button 
                                ...
                                className="bg-yellow-300 w-full h-10 font-bold cursor-pointer hover:bg-yellow-400 hover:shadow-xl/20 overflow-hidden transition-all duration-200 hover:ring-offset-2 active:ring-2 active:ring-red-800 active:rounded flex flex-row justify-center items-center" 
                ...
                <div className="text-xl flex flex-col gap-5">
                    ...
                    <p className="font-semibold text-2xl md:text-4xl">
                     ...
                     {location.pathname.includes('fertilizers') ?
                        null
                    : 
                        <p className="italic text-base font-medium">&#8377;59 Delivery Fee.</p>
                    }
                    <p 
