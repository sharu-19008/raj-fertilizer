    ...
    const seedsList = sortedSeedsList.map((seed)=>{
        return (
            <motion.div 
                ...
                key={seed.id}
                className="h-90 flex flex-col justify-between px-5 gap-3 sm:px-0 border border-gray-300 bg-white shadow-xl/30 sm:w-60 sm:h-140" >
                <div className="flex flex-row sm:flex-col sm:justify-normal">
                    
                    <Link to={`./${seed.id}`} className="w-full">
                        <img 
                            className="w-full pt-3 h-60 sm:h-70 sm:p-4 " 
                            src={seed.img} 
                    ...
                    <div className="flex flex-col justify-start items-start gap-2 px-3 mt-5 sm:mt-2 flex-1">
                        ...
                        <p className="bg-black text-white w-26 h-6 flex justify-center items-center sm:w-32  p-1 rounded-xl text-center font-semibold text-xs sm:text-sm">
                            {seed.availability}
                        </p>
                    </div>
                </div>
