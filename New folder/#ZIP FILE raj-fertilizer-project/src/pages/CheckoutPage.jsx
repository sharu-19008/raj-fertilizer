...
export default function CheckoutPage() {
    ...
    const totalPrice = cartItems.length > 1 ? cartItems.reduce((sum,item)=>{
                    ...
                    <div className="flex flex-col gap-8 md:gap-15">
                        <div className="flex flex-col sm:items-center">
                            <motion.button 
                                ...
                                className="cursor-pointer bg-amber-300 text-sm w-full h-8 font-medium rounded-4xl hover:bg-amber-400 sm:w-1/2 sm:text-base sm:h-10 md:w-1/4"
                                onClick={()=>{
                                    clearCart()
