...
export default function Home() {
    ...
    return (
        <section className="h-auto w-full flex flex-col items-center">
            ...
            <div className=" h-auto w-full flex flex-col justify-center px-10 py-15 gap-7 md:w-full md:px-20 lg:w-300">
                ...
                <Link 
                    ...
                    <motion.button
                        ...
                        className="bg-amber-500 cursor-pointer text-xl font-bold font-inter w-80 text-center px-10 py-3 text-white">
